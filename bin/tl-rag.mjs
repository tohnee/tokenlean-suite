 ...
 *   tl-rag live --base-url URL --api-key KEY [--model MODEL]
 */
...
const ragLive = join(here, '..', '03-rag-server', 'bench', 'live-provider-compare.mjs');
...
Examples:
  ...
  tl-rag live --base-url https://api.openai.com/v1 --api-key "$OPENAI_API_KEY"
`);
  process.exit(1);
}
